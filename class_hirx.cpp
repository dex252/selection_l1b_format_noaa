    ...
    bool HirxParser(Track track, string in_f)
    {
      ...
      //  cout << "FinalAllCur = " << AllCur << endl;
        ...
        if (count != 0)
        {
            ...
            in.read((char *)&cc, 128);
            wr.write((char *)&cc, 128);
            //подмена кол-ва строк
            i2 = htobe16(count);
            wr.write((char *)&i2, 2);
            in.seekg(2, ios::cur);
            //копирование 4478 байт от 130 -> 4608
            in.read((char *)&cc, 4478);
            wr.write((char *)&cc, 4478);
            ...
            for (size_t line = 0; line < ama_h_scnlin; line++)
            {
                ...
                {
                  //  cout << "LINE = " << line << endl;
                    in.read((char *)&cc, 4608);
                    wr.write((char *)&cc, 4608);
                }
                else
                {
                    in.seekg(4608, ios::cur);
                }
            }
